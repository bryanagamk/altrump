...
public class MachineUpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Machine machine = (Machine) getIntent().getExtras().get("machine");
        ...
        et_idMesin.setText(machine.getId_mesin());
        et_namaMesin.setText(machine.getAlamat());
        et_mobilNew.setText(price.get("MobilNew"));
        et_mobilRefill.setText(price.get("MobilRefill"));
        et_motorNew.setText(price.get("MotorNew"));
        et_motorRefill.setText(price.get("MotorRefill"));
